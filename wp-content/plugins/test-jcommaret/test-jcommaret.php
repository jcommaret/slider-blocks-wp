...
function create_block_test_jcommaret_block_init() {
	register_block_type( __DIR__ . '/build/test-bloc-1' );
...
// White list block so users cannot break anything
function citeo_allowed_block_types($allowed_block_types, $editor_context) {
    return array(
        'core/paragraph',
        'core/heading',
        'core/image',
        'core/button',
		'test-jcommaret/test-bloc-1'
    );
}

// Add the filter
add_filter('allowed_block_types_all', 'citeo_allowed_block_types', 10, 2);